...
function darbuotojaiHtml () {
  let div_darbuotojai = document.createElement("div");
      div_darbuotojai.setAttribute("class","darbuotojai");

    duomenysIsBD.forEach( element => {
        ...
        let miestas = document.createElement("p");
          miestas.innerText = element.address.city; 
          div_tekstas.appendChild(miestas);  
        let svetaine = document.createElement("a");
          svetaine.href = element.website;
          svetaine.innerText = element.website;
          svetaine.target = "_blank";       
          div_tekstas.appendChild(svetaine); 
          kortele.appendChild(div_tekstas);
          div_darbuotojai.appendChild(kortele);      
       });  
   
   document.body.appendChild(div_darbuotojai);
}
